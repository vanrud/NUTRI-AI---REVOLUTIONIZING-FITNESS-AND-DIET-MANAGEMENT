...
import 'schema/basic_details_record.dart';
import 'schema/pred_food_record.dart';
import 'schema/user_history_record.dart';
import 'schema/sugar_hist_record.dart';
import 'schema/bmi_chart_record.dart';
...
export 'schema/basic_details_record.dart';
export 'schema/pred_food_record.dart';
export 'schema/user_history_record.dart';
export 'schema/sugar_hist_record.dart';
export 'schema/bmi_chart_record.dart';
...
/// Functions to query BasicDetailsRecords (as a Stream and as a Future).
Future<int> queryBasicDetailsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BasicDetailsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BasicDetailsRecord>> queryBasicDetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BasicDetailsRecord.collection,
      BasicDetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BasicDetailsRecord>> queryBasicDetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query PredFoodRecords (as a Stream and as a Future).
Future<int> queryPredFoodRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PredFoodRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PredFoodRecord>> queryPredFoodRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PredFoodRecord.collection,
      PredFoodRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PredFoodRecord>> queryPredFoodRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Stream<List<UserHistoryRecord>> queryUserHistoryRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      UserHistoryRecord.collection,
      UserHistoryRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
...
/// Functions to query SugarHistRecords (as a Stream and as a Future).
Future<int> querySugarHistRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SugarHistRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SugarHistRecord>> querySugarHistRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SugarHistRecord.collection,
      SugarHistRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SugarHistRecord>> querySugarHistRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query BmiChartRecords (as a Stream and as a Future).
Future<int> queryBmiChartRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BmiChartRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BmiChartRecord>> queryBmiChartRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BmiChartRecord.collection,
      BmiChartRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BmiChartRecord>> queryBmiChartRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
