        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => BreakreciWidget(
            ...
            FFRoute(
              ...
              path: 'summaryPage',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Summary')
                  : SummaryWidget(),
            ),
            FFRoute(
              name: 'RecfoodsAll',
              path: 'recfoodsAll',
              builder: (context, params) => RecfoodsAllWidget(),
            ),
            FFRoute(
              name: 'TrackSugarLevel',
              path: 'tracksugarlvl',
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'TrackSugarLevel')
                  : TrackSugarLevelWidget(),
            ),
            FFRoute(
              name: 'Lunchreci',
              path: 'lunchreci',
              ...
              builder: (context, params) => LunchreciWidget(
                mealRef: params.getParam(
                  'mealRef',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              builder: (context, params) => DinnerreciWidget(
                mealRef: params.getParam(
                  'mealRef',
                  ParamType.Document,
                ),
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/NUTRI_AI_Logo.png',
